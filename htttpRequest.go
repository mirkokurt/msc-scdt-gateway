...
func readParamenters(b []byte) {
	...
	if err != nil {
		...
		b[16] = byte(payload.QUUPPA_TIMEOUT_PARAM & 255)
		b[17] = byte(payload.QUUPPA_TIMEOUT_PARAM >> 8)
		b[18] = byte(payload.NO_MOVE_ACTIONS_TIMEOUT_PARAM & 255)
		b[19] = byte(payload.NO_MOVE_ACTIONS_TIMEOUT_PARAM >> 8)
